...
class Articles extends Component {
  ...
  render() {
    return (
      <div id='articleDiv'>
        <blockquote class="embedly-card"><h4><a href="https://www.linkedin.com/pulse/introduction-web-programming-part-4-google-fonts-nicholas-white/">Introduction to Web Programming - Part 4 (Google Fonts)</a></h4><p>The previous article can be found at the link below https://www.linkedin.com/pulse/introduction-web-programming-part-3-css-basics-nicholas-white/</p></blockquote>
