        ...
        Click on the project pictures below and you will be redirected to a usable version.</p>
          ...
          <Carousel autoPlay={true} interval={3000} infiniteLoop={true} showThumbs={false} className='hackathonCarousel'>
                  ...
                  <div className='hackathonCarouselImageDiv'>
                      ...
                      <img src={require('../../assets/hackathon-pics/wip_logo.png')} className='whipLogoHover'></img>
                      <img src={require('../../assets/hackathon-pics/square_map.png')} className='whipLogoHover'></img>
                      </div>
          ...
          <h4 id='awardsHeader'>Awards</h4>
          <p>UB Hacks - Finalist (Third Place)</p>
          <p>Dandy Hacks - Google Cloud Platform Award</p>
          <p>Dandy Hacks - FactSet API Award</p>
